  ...
  alumni: {
    ...
    cohorts: [
      ...
      { id: 'cohort9',
        ...
        members: [
          { name: { ko: '권수연' }, sub: { ko: '노어노문학과 20' } },
          { name: { ko: '김서진' }, sub: { ko: '응용통계학과 21' } },
          { name: { ko: '김영현' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '김진하' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '김현동' }, sub: { ko: '산업공학과 20' } },
          { name: { ko: '남승우' }, sub: { ko: '경제학과 17' } },
          { name: { ko: '박서연' }, sub: { ko: '대기과학과 21' } },
          { name: { ko: '서연우' }, sub: { ko: '경영학과 18' } },
          { name: { ko: '신소연' }, sub: { ko: '계량위험관리학과 21' } },
          { name: { ko: '심은조' }, sub: { ko: '경영학과 대학원 22' } },
          { name: { ko: '유선재' }, sub: { ko: '응용통계학과 21' } },
          { name: { ko: '유희조' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '이성균' }, sub: { ko: '통계데이터사이언스학과 대학원 24' } },
          { name: { ko: '이승원' }, sub: { ko: '응용통계학과 22' } },
          { name: { ko: '이원준' }, sub: { ko: '신소재공학과 18' } },
          { name: { ko: '임선민' }, sub: { ko: '생명과학공학과 21' } },
          { name: { ko: '임세민' }, sub: { ko: '응용통계학과 21' } },
          { name: { ko: '장현빈' }, sub: { ko: '생화학과 19' } },
          { name: { ko: '전재병' }, sub: { ko: '통계데이터사이언스학과 대학원 24' } },
          { name: { ko: '정주영' }, sub: { ko: '응용통계학과 16' } },
          { name: { ko: '조세린' }, sub: { ko: '생명공학과 19' } },
          { name: { ko: '조의현' }, sub: { ko: '산업공학과 19' } }
        ] },
      { id: 'cohort8',
        title: { ko: '8기', en: '8th Cohort' },
        members: [
          { name: { ko: '강건우' }, sub: { ko: 'UIC 경제학과 18' } },
          { name: { ko: '김남훈' }, sub: { ko: '산업공학과 20' } },
          { name: { ko: '김지희' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '도승범' }, sub: { ko: '경제학과 대학원 22' } },
          { name: { ko: '백민준' }, sub: { ko: '경영학과 17' } },
          { name: { ko: '손승진' }, sub: { ko: '경영학과 18' } },
          { name: { ko: '송규원' }, sub: { ko: '응용통계학과 17' } },
          { name: { ko: '안세정' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '엄소은' }, sub: { ko: '건축학과 19' } },
          { name: { ko: '유채원' }, sub: { ko: '응용통계학과 21' } },
          { name: { ko: '이재우' }, sub: { ko: '혁신학과 대학원 22' } },
          { name: { ko: '장준혁' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '정건우' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '조보경' }, sub: { ko: '시스템반도체공학과 21' } },
          { name: { ko: '조찬형' }, sub: { ko: '경영학과 19' } },
          { name: { ko: '최윤서' }, sub: { ko: '도시공학과 20' } },
          { name: { ko: '한예림' }, sub: { ko: '응용통계학과 21' } },
      ...
      { id: 'cohort7',
        ...
        members: [
          ...
          { name: { ko: '김예진' }, sub: { ko: '천문우주학과 17' } },
          { name: { ko: '김원' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '김종민' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '김채은' }, sub: { ko: '컴퓨터과학과 20' } },
          { name: { ko: '김한빈' }, sub: { ko: '경영학과 17' } },
          { name: { ko: '김형민' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '박지은' }, sub: { ko: '응용통계학과 21' } },
          { name: { ko: '박지호' }, sub: { ko: '전기전자공학부 19' } },
          { name: { ko: '이승연' }, sub: { ko: '신소재공학과 대학원 22' } },
          { name: { ko: '이승주' }, sub: { ko: '정치외교학과 19' } },
          { name: { ko: '전재현' }, sub: { ko: '컴퓨터과학과 18' } },
          { name: { ko: '전혜령' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '진유리' }, sub: { ko: '언더우드 경제학과 18' } },
          { name: { ko: '최명헌' }, sub: { ko: '응용통계학과 18' } }
        ] },
      { id: 'cohort6',
        title: { ko: '6기', en: '6th Cohort' },
        members: [
          { name: { ko: '강민주' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '강현우' }, sub: { ko: '경제학과 15' } },
          { name: { ko: '김서현' }, sub: { ko: '응용통계학과 20' } },
          { name: { ko: '김지오' }, sub: { ko: '나노과학공학과 19' } },
          { name: { ko: '박상윤' }, sub: { ko: '경영학과 17' } },
          { name: { ko: '박세승' }, sub: { ko: '경영학과 대학원 21' } },
          { name: { ko: '박수빈' }, sub: { ko: '통계데이터사이언스학과 대학원 24' } },
          { name: { ko: '박준우' }, sub: { ko: '경제학과 17' } },
          { name: { ko: '손예진' }, sub: { ko: '경제학과 19' } },
          { name: { ko: '안민용' }, sub: { ko: '컴퓨터과학과 18' } },
          { name: { ko: '이승재' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '장윤태' }, sub: { ko: '수학과 20' } },
          { name: { ko: '조수연' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '최연수' }, sub: { ko: '경영학과 19' } },
          { name: { ko: '황다연' }, sub: { ko: '계량위험관리학과 18' } }
        ] },
      { id: 'cohort5',
        title: { ko: '5기', en: '5th Cohort' },
        members: [
          { name: { ko: '김도언' }, sub: { ko: '철학과 14' } },
          { name: { ko: '김보아' }, sub: { ko: '창의기술경영 18' } },
          { name: { ko: '김하람' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '김현준' }, sub: { ko: '응용통계학과' } },
          { name: { ko: '박민지' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '박채은' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '박희경' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '변수현' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '임낙준' }, sub: { ko: '응용통계학과 16' } },
          { name: { ko: '조신형' }, sub: { ko: '경영학과 17' } },
          { name: { ko: '차지수' }, sub: { ko: '언론홍보영상학부 15' } },
          { name: { ko: '편시현' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '한영웅' }, sub: { ko: '신학과 18' } },
          { name: { ko: '허유진' }, sub: { ko: '응용통계학과 18' } }
        ] },
      { id: 'cohort4',
        title: { ko: '4기', en: '4th Cohort' },
        members: [
          { name: { ko: '김경훈' }, sub: { ko: '응용통계학과 16' } },
          { name: { ko: '김동욱' }, sub: { ko: '영어영문학과 15' } },
          { name: { ko: '김새민' }, sub: { ko: '국어국문학과 18' } },
          { name: { ko: '김선우' }, sub: { ko: '응용통계학과 16' } },
          { name: { ko: '김승규' }, sub: { ko: '기계공학과 16' } },
          { name: { ko: '김승희' }, sub: { ko: '경제학과 17' } },
          { name: { ko: '김연수' }, sub: { ko: '언론홍보영상학부 16' } },
          { name: { ko: '김율' }, sub: { ko: '국어국문학과 대학원 13' } },
          { name: { ko: '김정환' }, sub: { ko: '문헌정보학과 18' } },
          { name: { ko: '배시예' }, sub: { ko: '경제학과 18' } },
          { name: { ko: '서기원' }, sub: { ko: '컴퓨터과학과 15' } },
          { name: { ko: '송재용' }, sub: { ko: '응용통계학과 15' } },
          { name: { ko: '안지민' }, sub: { ko: '경제학과 17' } },
          { name: { ko: '위효원' }, sub: { ko: '컴퓨터과학과 18' } },
          { name: { ko: '이의동' }, sub: { ko: '컴퓨터과학과 15' } },
          { name: { ko: '이준엽' }, sub: { ko: '산업공학과 17' } },
          { name: { ko: '이청파' }, sub: { ko: '응용통계학과 15' } },
          { name: { ko: '이학림' }, sub: { ko: '수학과 16' } },
          { name: { ko: '임지원' }, sub: { ko: '통계데이터사이언스학과 대학원 20' } },
          { name: { ko: '최수아' }, sub: { ko: '응용통계학과 19' } },
          { name: { ko: '최영준' }, sub: { ko: '사회학과 18' } },
          { name: { ko: '호은재' }, sub: { ko: '언론홍보영상학부 16' } },
          { name: { ko: '홍석현' }, sub: { ko: '창의기술경영 15' } }
        ] },
      { id: 'cohort3',
        title: { ko: '3기', en: '3rd Cohort' },
        members: [
          { name: { ko: '곽경민' }, sub: { ko: '경영학과 15' } },
          { name: { ko: '김덕휘' }, sub: { ko: '컴퓨터과학과 15' } },
          { name: { ko: '김범수' }, sub: { ko: '수학과 18' } },
          { name: { ko: '김상혁' }, sub: { ko: '스포츠응용산업학과 15' } },
          { name: { ko: '김승현' }, sub: { ko: '응용통계학과 16' } },
          { name: { ko: '김지우' }, sub: { ko: '응용통계학과 16' } },
          { name: { ko: '나하나' }, sub: { ko: '도시공학과' } },
          { name: { ko: '노영지' }, sub: { ko: '생명공학과 18' } },
          { name: { ko: '류동철' }, sub: { ko: '컴퓨터과학과 15' } },
          { name: { ko: '문해일' }, sub: { ko: '생화학부 19' } },
          { name: { ko: '민동재' }, sub: { ko: '경제학과 15' } },
          { name: { ko: '박상용' }, sub: { ko: '경제학과 14' } },
          { name: { ko: '박은지' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '변승우' }, sub: { ko: '산업공학과 17' } },
          { name: { ko: '손동재' }, sub: { ko: '경제학과 대학원 13' } },
          { name: { ko: '유승용' }, sub: { ko: '경제학과 15' } },
          { name: { ko: '윤나은' }, sub: { ko: '경영학과 16' } },
          { name: { ko: '이연주' }, sub: { ko: '산업공학과 16' } },
          { name: { ko: '이재환' }, sub: { ko: '응용통계학과 15' } },
          { name: { ko: '이재훈' }, sub: { ko: '응용통계학과 16' } },
          { name: { ko: '이진우' }, sub: { ko: '응용통계학과 17' } },
          { name: { ko: '이학민' }, sub: { ko: '사회학과 14' } },
          { name: { ko: '최동훈' }, sub: { ko: '산업공학과 15' } },
          { name: { ko: '최의준' }, sub: { ko: '통계데이터사이언스학과 대학원 14' } }
        ] },
      { id: 'cohort2',
        title: { ko: '2기', en: '2nd Cohort' },
        members: [
          { name: { ko: '간정현' }, sub: { ko: '사회학과 14' } },
          { name: { ko: '김다윗' }, sub: { ko: '경제학과 대학원 12' } },
          { name: { ko: '김연강' }, sub: { ko: '응용통계학과 15' } },
          { name: { ko: '김정수' }, sub: { ko: '대학원' } },
          { name: { ko: '남승희' }, sub: { ko: '문헌정보학과 16' } },
          { name: { ko: '민동은' }, sub: { ko: '철학과 16' } },
          { name: { ko: '박국현' }, sub: { ko: '응용통계학과 15' } },
          { name: { ko: '박진아' }, sub: { ko: '통계데이터사이언스학과 대학원 19' } },
          { name: { ko: '신은수' }, sub: { ko: '응용통계학과 대학원 14' } },
          { name: { ko: '이관용' }, sub: { ko: '도시공학과 대학원 12' } },
          { name: { ko: '이승원' }, sub: { ko: '사회학과 17' } },
          { name: { ko: '이용주' }, sub: { ko: '인공지능 대학원 19' } },
          { name: { ko: '이정환' }, sub: { ko: '경제학과 대학원 13' } },
          { name: { ko: '이해환' }, sub: { ko: '경제학과 대학원 14' } },
          { name: { ko: '임서하' }, sub: { ko: '경제학과 17' } },
          { name: { ko: '정민지' }, sub: { ko: '응용통계학과 16' } },
          { name: { ko: '최수영' }, sub: { ko: '경제학과 대학원 10' } },
          { name: { ko: '최주안' }, sub: { ko: '통계데이터사이언스학과 대학원 19' } }
        ] },
      { id: 'cohort1',
        title: { ko: '1기', en: '1st Cohort' },
        members: [
          { name: { ko: '강다연' }, sub: { ko: '경영학과 16' } },
          { name: { ko: '강태규' }, sub: { ko: '경제학과 대학원 12' } },
          { name: { ko: '권다희' }, sub: { ko: '응용통계학과 대학원 16' } },
          { name: { ko: '김경률' }, sub: { ko: '경제학과 14' } },
          { name: { ko: '김민준' }, sub: { ko: '응용통계학과 17' } },
          { name: { ko: '민형규' }, sub: { ko: '통계데이터사이언스학과 대학원 14' } },
          { name: { ko: '박상우' }, sub: { ko: '응용통계학과' } },
          { name: { ko: '설영환' }, sub: { ko: '응용통계학과' } },
          { name: { ko: '손진원' }, sub: { ko: '통계데이터사이언스학과 대학원' } },
          { name: { ko: '안주영' }, sub: { ko: '응용통계학과 대학원' } },
          { name: { ko: '이동석' }, sub: { ko: '응용통계학과 15' } },
          { name: { ko: '이명진' }, sub: { ko: '대기과학과/산업공학과 대학원 16' } },
          { name: { ko: '이상효' }, sub: { ko: '심리학과 14' } },
          { name: { ko: '이승은' }, sub: { ko: '응용통계학과 17' } },
          { name: { ko: '이승한' }, sub: { ko: '경영학과 15' } },
          { name: { ko: '이주경' }, sub: { ko: '응용통계학과 대학원' } },
          { name: { ko: '임지현' }, sub: { ko: '응용통계학과 대학원' } },
          { name: { ko: '임채확' }, sub: { ko: '응용통계학과 14' } },
          { name: { ko: '조영민' }, sub: { ko: '경제학과 13' } },
          { name: { ko: '조유나' }, sub: { ko: '응용통계학과 대학원' } },
          { name: { ko: '차수만' }, sub: { ko: '응용통계학과 15' } },
          { name: { ko: '최병준' }, sub: { ko: '응용통계학과 18' } },
          { name: { ko: '최석영' }, sub: { ko: '응용통계학과 대학원 15' } },
          { name: { ko: '홍찬희' }, sub: { ko: '응용통계학과 대학원' } }
        ] }
    ]
  },
  /* ---------- 모집 ---------- */
